...
class Image:
    ...
    Image class object
    """
    def __init__(self, radius, zenith_row, zenith_col, az_off, threshold, timestamp, limit_zenith):
        self.radius = radius
        ...
        self.limit_zenith = limit_zenith
...
cta = Camera(
     ...
     Image(849, 849, 849, 87.1*u.deg, 0.003, ['UTC1', 'TIMEUTC'], 30),
     5.7
)
